...
<project name="${ComponentID}-rest-build" basedir=".." xmlns:webproject3="http://www.netbeans.org/ns/web-project/3" xmlns:webproject2="http://www.netbeans.org/ns/web-project/2" xmlns:webproject1="http://www.netbeans.org/ns/web-project/1" xmlns:jaxrs="http://www.netbeans.org/ns/jax-rs/1">
    ...
    <target name="check-rest-config-props" depends="-do-init">
        <condition property="do-generate-rest-config">
            <and>
                <equals arg1="${r'${rest.config.type}'}" arg2="ide"/>
    ...
    <target name="generate-rest-config" depends="check-rest-config-props" if="do-generate-rest-config">
        <mkdir dir="${r'${build.generated.sources.dir}'}/rest/org/netbeans/rest/application/config/"/>
        <echo file="${r'${build.generated.sources.dir}'}/rest/org/netbeans/rest/application/config/ApplicationConfig.java">/*
 ...
 * 
 */
@javax.ws.rs.ApplicationPath("${r'${rest.resources.path}'}")
