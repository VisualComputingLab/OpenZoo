 ...
 */
public class TwitterListenerWorker extends OpenZooWorker {
    
    private final OpenZooOutputConnection outConn = new OpenZooOutputConnection(this, "output_1");
    private final OpenZooLoggingConnection logConn = new OpenZooLoggingConnection(this);

    public TwitterListenerWorker(String threadName)
    {        
        super(threadName);
        
        log.debug("-- TwitterListenerWorker()");
    }
    ...
    public void run()
    {
        log.debug("-- TwitterListenerWorker.run");
