 ...
 */
public class SearchWorker extends OpenZooWorker {

    private OpenZooInputConnection inConn = new OpenZooInputConnection(this, "input");

    private OpenZooOutputConnection outConn_1 = new OpenZooOutputConnection(this, "output_1");

    private OpenZooLoggingConnection logConn = new OpenZooLoggingConnection(this);

    
    public SearchWorker(String threadName)
    {        
        super(threadName);
        
        log.debug("-- SearchWorker()");
    }
