 ...
 */
public class URLUnwrapperWorker extends OpenZooWorker {
    
    private final OpenZooInputConnection inConn = new OpenZooInputConnection(this, "input");
    private final OpenZooOutputConnection outConnDl = new OpenZooOutputConnection(this, "output_1");
    private final OpenZooOutputConnection outConnDb = new OpenZooOutputConnection(this, "output_2");
    ...
    public void run()
    {
        log.debug("-- URLUnwrapperWorker.run");
        ...
        logConn.debug("-- URLUnwrapperWorker.run");
