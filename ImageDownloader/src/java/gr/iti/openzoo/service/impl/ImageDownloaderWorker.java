 ...
 */
public class ImageDownloaderWorker extends OpenZooWorker {
    ...
    public ImageDownloaderWorker(String threadName)
    {        
        super(threadName);
        
        log.debug("-- ImageDownloaderWorker()");
    }
    ...
    public void run()
    {
        log.debug("-- ImageDownloaderWorker.run");
